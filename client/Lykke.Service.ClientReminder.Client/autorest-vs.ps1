...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.ClientReminder.Client/AutorestClient --namespace=Lykke.Service.ClientReminder.Client.AutorestClient