...
using Lykke.Service.ClientReminder.Modules;
...
namespace Lykke.Service.ClientReminder
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                builder.RegisterModule(new ServiceModule(appSettings, appSettings.Nested(x => x.ClientReminderService), Log));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("ClientReminder", ex => new { Message = "Technical problem" });
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.ClientReminderService.Db.LogsConnString);
